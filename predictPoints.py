...
import caffe
MODEL_FILE = 'examples/kaggle_facialpoints/fkp_deploy.prototxt'
PRETRAINED = 'examples/kaggle_facialpoints/model/fkp_iter_1000000.caffemodel' 
height = 96
...
t = 'examples/kaggle_facialpoints/h5/test'
